...
def launch_setup(context, *args, **kwargs):
    ...
    #     "map_frame":              "map",
    #     "odom_frame":             "odom",
    #     "base_link_frame":        "oak",  # or f"{name}_link"
    #     "world_frame":            "map",
    #     "imu0": "/oak/imu/data",
    #     "imu0_linear_acceleration_covariance": [0.05, 0.0, 0.0,
    #                                             0.0, 0.05, 0.0,
    #                                             0.0, 0.0, 0.05],
    ...
    actions.append(
        Node(
            ...
            output="screen",
            parameters=[os.path.join(pkg_rw, 'config', 'ekf.yaml')
            ]
...
def generate_launch_description():
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument(
            "params_file",
            default_value=os.path.join(pkg_rw, "config", "camera.yaml"),
        ...
        DeclareLaunchArgument(
            "rviz_config",
            default_value=os.path.join(pkg_rw, "rviz", "rgbd.rviz"),
