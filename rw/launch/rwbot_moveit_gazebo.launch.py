...
def launch_setup(context, *args, **kwargs):
    ...
    attach_xyz = LaunchConfiguration('attach_xyz', default='"0 0 0.0401"')
    attach_rpy = LaunchConfiguration('attach_rpy', default='"0 0 3.14159265"')
    ...
    robot_gazebo_launch = IncludeLaunchDescription(
        # PythonLaunchDescriptionSource(PathJoinSubstitution([FindPackageShare('rw'), 'launch', '_robot_on_mbot_gazebo.launch.py'])),
